...
$(document).ready(function() {
  ...
  firebaseMessages.on('child_added', function(snapshot) {
    ...
    //1. Get the messages div
    //2. Append some text into it
    //3. Use message.name and message.text somehow in there
  ...
  $('.newMessageForm').submit(function (event) {
    ...
    firebaseMessages.push({ 'name': username, 'text': newMessage });
    ...
    // 3) Use firebaseMessages.push to add the new message object to firebase
